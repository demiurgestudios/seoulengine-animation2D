/**
 * \file Animation2DPlayClipInstance.h
...
#pragma once
#ifndef ANIMATION2D_PLAY_CLIP_INSTANCE_H
#define ANIMATION2D_PLAY_CLIP_INSTANCE_H
...
namespace Seoul { namespace Animation2D { class ClipInstance; } }
