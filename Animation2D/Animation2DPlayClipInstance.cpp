/**
 * \file Animation2DPlayClipInstance.cpp
	...
	, m_bDone(false)
{
	...
	m_pClipInstance.Reset(SEOUL_NEW(MemoryBudgets::Animation2D) ClipInstance(static_cast<State&>(r.GetStateInterface()).GetInstance(), pClip, settings));
}
